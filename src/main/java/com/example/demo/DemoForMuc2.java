 ...
 */
public class DemoForMuc2 {
    private static final Logger logger = LoggerFactory.getLogger(DemoForMuc2.class);
...
//            MultiUserChat chatRoom = MucUtil.createChatRoom("lyzgroup2", "xiaoli", "123456", xmppConn);
            MucUtil.join("lyzgroup2@muc.aiorsoft.cn", "o1", "", xmppConn);
            MucUtil.join("lyzgroup@muc.aiorsoft.cn", "o1", "", xmppConn);
            //查询所有群组
...
//                MucUtil.join(r.getJid().toString(), "test222", "", xmppConn2);
            ...
            multiUserChat.addMessageListener(new MessageListener() {
                ...
                public void processMessage(final Message message) {
                    ...
                    System.err.println("o1: -=-lyzgroup2@muc.aiorsoft.cn" + "接收消息： " + message.getBody());
                }
            });
            ...
            while (true) {
                ...
                multiUserChat.sendMessage("Hello World Muc" + i1);
//                multiUserChat2.sendMessage("Hello World Muc" + i1);
            }
    ...
    public static XMPPTCPConnectionConfiguration getConnection() throws XmppStringprepException {
        ...
        //用户名 密码
        config.setUsernameAndPassword("o1", "123456");
        //禁用主机名验证
